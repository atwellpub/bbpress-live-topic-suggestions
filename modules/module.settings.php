<?php
	...
	?>
		...
		<textarea name="_bbp_livesearch_beforehtml" id="_bbp_livesearch_beforehtml" class="large-text" /> <?php bbp_form_option( '_bbp_livesearch_beforehtml', '<h3 class="bbpress_livesearch_header">Check out these topics first!</h3>' ); ?></textarea>
	...
	?>
		...
		<textarea name="_bbp_livesearch_afterhtml" id="_bbp_livesearch_afterhtml" class="large-text" /> <?php bbp_form_option( '_bbp_livesearch_afterhtml', '<br><br>' ); ?></textarea>
